...
Purpose: Step-by-step checklist reveal for evidence or process cues.
...
```powershell
npx hyperframes render composition.html --variables-file sample-vars.json --strict-variables --output 06-checklist-reveal.mp4
```
